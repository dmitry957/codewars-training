...
[Codewars Link](https://www.codewars.com/kata/68851563123e161332d2a84b/python)
...
1. Begin at index 0.
2. Read the value at the current index to get the next index.
3. Continue stepping through the array.
4. If you encounter an index you've already visited, you've found a loop — return `True` (or your language's equivalent).
5. If a step takes you to an index outside the array, the traversal ends — return `False` (or your language's equivalent).
